        ...
        <div className="w-4/5 md:w-[40rem] m-auto text-sm text-justify flex flex-col gap-4 md:mr-10">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <h2 className="font-semibold underline">Front End: </h2>
                <>
                  <img
                    alt="svgImg"
                    width={26}
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">JavaScript</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">React.js</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">HTML5</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">CSS 3</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Tailwind CSS</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Bootstrap</h3>
                </>
              </motion.div>
              <motion.div
                initial="hidden"
                ...
                className="flex flex-wrap items-center"
              >
                <h2 className="font-semibold underline">Back End: </h2>
                <>
                  <img
                    alt="svgImg"
                    width={26}
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Node.js</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                ...
                <>
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Mongo DB</h3>
                </>
              </motion.div>
              <motion.div
                initial="hidden"
                ...
                className="flex flex-wrap items-center"
              >
                <h2 className="font-semibold underline">Familiar With: </h2>{' '}
                <>
                  <img
                    alt="svgImg"
                    width={24}
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Redux</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Next.js</h3>
                </>
                <>
                  <img
                    alt="svgImg"
              ...
              >
                ...
                <>
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Auth0</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Stripe</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">JWT</h3>
                </>
                <>
                  <img
                    alt="svgImg"
                  ...
                  />
                  <h3 className="inline font-semibold mr-2">Git</h3>
                </>
              </motion.div>
            </div>
          </motion.div>
